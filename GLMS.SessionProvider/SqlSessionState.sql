...
IF (EXISTS (SELECT name FROM sysobjects WHERE (name = N'SessionList') AND (type = 'V')))
    DROP View [dbo].SessionList
GO
    ...
    SET @cmd = N'
        ...
        AS
            CREATE TABLE [PLinx.ASPState].dbo.ASPStateTempSessions (
                ...
                SessionUser			nvarchar(128)	NULL,
                SessionAccount		nvarchar(128)	NULL,
    ...
    SET @cmd = N'
        ...
        AS    
            ...
            SET Expires = DATEADD(n, @timeout, GETUTCDATE()), 
				...
				LastUrl = IsNull(@lastUrl,LastUrl)
            WHERE SessionId = @id AND LockCookie = @lockCookie
...
CREATE VIEW dbo.SessionList AS
	SELECT SessionId, Created, DATEDIFF(MINUTE,LockDateLocal,GETDATE()) as IdleTime, SessionUser, SessionAccount, LastUrl from dbo.ASPStateTempSessions
GO
