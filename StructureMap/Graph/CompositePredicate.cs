...
namespace StructureMap.Graph
{
    ...
    {
        private readonly List<Func<T, bool>> _list;
        private Func<T, bool> _matchesAll;
        private Func<T, bool> _matchesAny;
        private Func<T, bool> _matchesNone;

        public CompositePredicate()
        {
            _list = new List<Func<T, bool>>();
            _matchesAll = x => true;
            _matchesAny = x => true;
            _matchesNone = x => false;
        }
