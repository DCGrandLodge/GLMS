...
[assembly: Elmah.Scc("$Id: ErrorLogModule.cs 912 2011-12-18 19:27:06Z azizatif $")]
...
namespace Elmah
{
    ...
    public class ErrorLogModule : HttpModuleBase, IExceptionFiltering
    {
        ...
        {
            args.LogID = LogException(args.Exception, args.Context);
        }
        ...
        protected virtual string LogException(Exception e, HttpContext context)
        {
            if (e == null)
