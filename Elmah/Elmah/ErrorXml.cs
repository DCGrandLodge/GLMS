...
namespace Elmah
{
    ...
    public sealed class ErrorXml
    {
        ...
        private static void ReadXmlAttributes(XmlReader reader, Error error)
        {
            ...
            error.Sequence = reader.GetAttribute("sequence");
            ...
            error.Time = timeString.Length == 0 ? new DateTime() : XmlConvert.ToDateTime(timeString, XmlDateTimeSerializationMode.Unspecified);
        ...
        private static void ReadInnerXml(XmlReader reader, Error error)
        {
            ...
            while (reader.IsStartElement())
            {
                ...
                switch (reader.Name)
                {
                    case "entityValidationErrors": collection = error.EntityValidationErrors; break;
        ...
        private static void WriteXmlAttributes(Error error, XmlWriter writer)
        {
            ...
            WriteXmlAttribute(writer, "sequence", error.Sequence);
        ...
        private static void WriteInnerXml(Error error, XmlWriter writer)
        {
            ...
            WriteCollection(writer, "entityValidationErrors", error.EntityValidationErrors);
