...
[assembly: Elmah.Scc("$Id: ErrorLogPage.cs 739 2010-10-19 00:08:29Z azizatif $")]
...
namespace Elmah
{
    ...
    internal sealed class ErrorLogPage : ErrorPageBase
    {
        ...
        private void RenderErrors(HtmlTextWriter writer)
        {
            ...
            headRow.Cells.Add(FormatCell(new TableHeaderCell(), "Err#", "errno-col"));
            ...
            for (int errorIndex = 0; errorIndex < _errorEntryList.Count; errorIndex++)
            {
                ...
                bodyRow.Cells.Add(FormatCell(new TableCell(), error.Sequence, "errno-col"));
