...
[assembly: Elmah.Scc("$Id: ErrorLog.cs 698 2010-01-09 19:20:54Z azizatif $")]
...
namespace Elmah
{
    ...
    public abstract class ErrorLog
    {
        ...
        {
            return GetDefault().Log(new Elmah.Error(ex));
        }

        public abstract string Log(Error error);
        public abstract void ResolveError(Guid errorID, bool resolved);
        ...
        public abstract string GetErrorIDBySequence(int sequence);
        ...
        public abstract int GetErrors(int pageIndex, int pageSize, IList errorEntryList, bool includeResolved = true);
        ...
        public virtual void DeleteErrors(DateTime? olderThan)
        {
            throw new NotImplementedException();
        }

        private delegate int GetErrorsHandler(int pageIndex, int pageSize, IList errorEntryList, bool resolved = true);
        ...
        public static ErrorLog GetDefault(HttpContext context = null)
        {
        ...
        private static string InferApplicationName(HttpContext context)
        {
            ...
            {
                //
                // Still no luck? Try HttpRuntime.AppDomainAppId or HttpRuntime.AppDomainAppVirtualPath,
                // which are available even under partial trust.
                //
